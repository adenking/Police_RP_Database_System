...
// Check connection
	...
	<div id="login">';
		$result = mysqli_query($con,"SELECT * FROM Licensedata 
			WHERE username LIKE '$_POST[searchname]' ORDER BY username");
		echo "<table border='1'>
...
echo "</td>";
echo "<td>" . "<form action=\"commentlogadd.php\" method=\"post\">
<input type=\"hidden\" name=\"Username\" value=\"" . $row['UserName'] . "\">
<input type=\"submit\" value=\"Add Comment\">
</form>";
if ($tempComments !== null) 
{
	echo "<form action=\"commentlogclear.php\" method=\"post\">
	<input type=\"hidden\" name=\"Username\" value=\"" . $row['UserName'] . "\">
	<input type=\"submit\" value=\"Clear Comment\">
</form>";
}
echo "</td>";
echo "</tr>";  
