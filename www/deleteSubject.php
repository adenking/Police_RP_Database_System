...
//mysqli_query($con, "UPDATE Licensedata SET DriversLicense=0 WHERE UserName='$_POST[Username]'");
...
<div id="login">';
logIt($_POST['Username'], '3 test', $_SESSION['user']['username'],'3 test', 3, $con);


echo $_POST['Username'] . "deleted from database.";
