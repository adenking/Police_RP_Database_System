...
// Check connection
  ...
  <div id="login">';
    ...
    $saved = mysqli_query($con, "UPDATE Licensedata SET Comments='' WHERE UserName='" . $_POST['Username'] . "'");
    
    if($saved)
    {
     echo "All Comments Cleared From " . $_POST['Username'];
   }

   logIt($_POST['Username'], $prevData, $_SESSION['user']['username'], '', 1, $con);
